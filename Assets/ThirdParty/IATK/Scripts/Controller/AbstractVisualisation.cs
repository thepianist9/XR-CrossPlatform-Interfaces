...
namespace IATK
{
    public abstract class AbstractVisualisation : MonoBehaviour
    {
        ...
        /// <returns></returns>
        protected View ApplyGeometryAndRendering(CreationConfiguration configuration, ref ViewBuilder builder, Material sphereMaterial)
        {
            Material mt = null;
            ...
            switch (configuration.Geometry)
            {
                ...
                case AbstractVisualisation.GeometryType.Points:
                    ...
                    return builder.updateView().
                       applyWithMaterial(gameObject, mt, false, sphereMaterial);
