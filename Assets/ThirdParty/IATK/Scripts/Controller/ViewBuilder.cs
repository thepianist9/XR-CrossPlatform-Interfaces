...
namespace IATK
{
    ...
    public class ViewBuilder
    {
        ...
        public View apply(GameObject parent, Material material, bool linking)
        {
            parent.name = Name;
            ...
            if (!linking)
            {
                foreach (Vector3 p in positions)
                {
                    ...
                    point.transform.SetParent(viewGameObject.transform, false);
        ...
        public View applyWithMaterial(GameObject parent, Material material, bool linking, Material sphereMaterial)
        {
            parent.name = Name;
            ...
            if (!linking)
            {
                ...
                {
                    GameObject point = GameObject.CreatePrimitive(PrimitiveType.Sphere);
                    point.GetComponent<MeshRenderer>().material = sphereMaterial;
                    point.layer = 6;
                    point.transform.position = p;
