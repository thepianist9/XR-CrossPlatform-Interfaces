...
namespace IATK
{
    ...
    public class Axis : MonoBehaviour
    {
        ...
        public void Initialise(DataSource srcData, AttributeFilter attributeFilter, Visualisation visualisation)
        {
            ...
            dataSource = srcData;
            var sourcedata = srcData.Select(m => m.Identifier).ToArray();


            int idx = Array.IndexOf(sourcedata, attributeFilter.Attribute);
            SourceIndex = idx;
        ...
        public void SetDirection(int direction)
        {
            ...
            switch (direction)
            {
                case 1:
                    ...
                    transform.GetChild(3).localPosition = new Vector3(-0.01f,0,0);
                    transform.GetChild(2).localPosition = new Vector3(0.07f, 0.5f, -0.09f);
                ...
                case 2:
                    ...
                    transform.GetChild(2).localPosition = new Vector3(0.06f, 0.5f, -0.09f);
                    transform.GetChild(3).localPosition = new Vector3(0.01f, 0f, 0);
                ...
                case 3:
                    ...
                    transform.GetChild(3).localPosition = new Vector3(0, 0f, -0.01f);
                    transform.GetChild(3).localEulerAngles = new Vector3(0, 90f, 0);
                    transform.GetChild(2).localPosition = new Vector3(-0.09f, 0.5f, 0.1f);
                    transform.GetChild(2).localEulerAngles = new Vector3(0, 90, -90);
                    SetXLocalPosition(minNormaliserObject, -minNormaliserObject.transform.localPosition.x);
                    SetXLocalPosition(maxNormaliserObject, -maxNormaliserObject.transform.localPosition.x);
                    minNormaliserObject.localEulerAngles = new Vector3(90, 90, 0);
                    maxNormaliserObject.localEulerAngles = new Vector3(90, 90, 0);
