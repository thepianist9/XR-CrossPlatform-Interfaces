...
namespace Game
{
    ...
    /// </summary>
    public class XROptionalConnectionManager : MonoBehaviour
    {
        [SerializeField]
        ...
        XRConnectionState m_CurrentState;

        internal XROfflineState m_Offline;

        internal XRClientConnectingState m_ClientConnecting;

        internal XRClientConnectedState m_ClientConnected;

        internal XRClientPreloadingState m_ClientPreloading;

        internal XRStartingHostState m_StartingHost;

        internal XRHostingState m_Hosting;
        ...
        void Start()
        {
            m_Offline = new XROfflineState(this);
            m_ClientConnecting = new XRClientConnectingState(this);
            m_ClientConnected = new XRClientConnectedState(this);
            m_ClientPreloading = new XRClientPreloadingState(this);
            m_StartingHost = new XRStartingHostState(this);
            m_Hosting = new XRHostingState(this);
        ...
        internal void ChangeState(XRConnectionState nextState)
        {
